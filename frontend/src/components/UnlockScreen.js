...
import { Lock, Eye, EyeOff, Smartphone, LogOut } from 'lucide-react';
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 p-4" dir="rtl">
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-400 mt-2">أدخل كلمة المرور لفتح القفل</p>
        </div>
        ...
        <div className="glass-dark rounded-2xl p-8 border border-orange-500/30">
          <div className="text-center mb-6">
            ...
            <h2 className="text-xl font-semibold text-white mb-2">فتح القفل</h2>
            <p className="text-gray-400 text-sm">
              تم قفل التطبيق للحماية. الجلسة محفوظة.
            </p>
          </div>
        ...
        <div className="mt-6 text-center">
          <div className="glass-dark rounded-xl p-4 border border-white/5">
            ...
            <p className="text-xs text-gray-500">
              بياناتك محفوظة وآمنة. سيتم استكمال الجلسة بعد فتح القفل.
            </p>
          </div>
        </div>
      </div>
